...
public class Pivo extends Roba implements Upis_u_datoteku{
    
    private String tip;

    public Pivo(String tip, String naziv, double cena, double litraza, double promil, int stanje, int kod) {
   ...
   public static boolean proveriKod(ArrayList<Pivo> ip, int kod){
